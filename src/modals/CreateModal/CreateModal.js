...
const CreateModal = ({ CreateModalStatus, toggleCreateModal }) => {
  return (
    <>
      <div
        className={
          CreateModalStatus ? "createWineList" : "createWineList--inactive"
        }
      >
        <div className="becomesommlier__container">
          <div className="createWineList__header">
            <div className="createWineList__header__title">
              create a wine list
            </div>
            <BsXLg
              className="createWineList__close"
          ...
          <div className="createWineList_wine__container">
            <div className="createWineList_wine__box">
              <div className="createWineList_wine__profile_box">
                <img
                  src="https://images.vivino.com/thumbs/MhiwIbE4TmSLMfjD-EKYjg_pb_x300.png"
                  className="createWineList_wineImage"
                />
              </div>
              <div className="createWineList_wine__description_box">
                <div className="createWineList_wine__description_font">
                  Matsu <br></br>El Viejo 2018
                </div>
              </div>
            </div>
            <div className="createWineList_wine__icon_box">
              <div className="createWineList_wine__icon">
                <BsFonts className="createWineList_wine__icon__text" />
              </div>
              <div className="createWineList_wine__icon">
                <BsX className="createWineList_wine__icon__text" />
              </div>
            </div>
          </div>
          ...
          <div className="createWineList_tag_container">
            <div className="createWineList__tag_button">
              <input
                className="createWineList__tag-input"
          ...
          <div className="createWineList__tag__items___container">
            <div className="createWineList__tags">
              <div className="createWineList__tag">
                <BsX className="createWineList__tag__close_icon" />
                <div className="createWineList__tag__name_font">acidic</div>
              </div>
              <div className="createWineList__tag">
                <BsX className="createWineList__tag__close_icon" />
                <div className="createWineList__tag__name_font">light</div>
              </div>
              <div className="createWineList__tag">
                <BsX className="createWineList__tag__close_icon" />
                <div className="createWineList__tag__name_font">dry</div>
              </div>
              <div className="createWineList__tag">
                <BsX className="createWineList__tag__close_icon" />
                <div className="createWineList__tag__name_font">steak</div>
              </div>
              <div className="createWineList__tag">
                <BsX className="createWineList__tag__close_icon" />
                <div className="createWineList__tag__name_font">picnic</div>
              </div>
            </div>
          </div>
          <div className="createWineList__comment__container">
            <div className="createWineList__comment__button">
              <div className="createWineList__comment__font">

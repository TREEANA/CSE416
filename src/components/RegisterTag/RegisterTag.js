        ...
        <>
            <div className = "registertag">
                ...
                <div className = "registertag__main">
                    ...
                    <div className = "registertag_subtitle"> choose the tags you are interested in! </div>
                    <div className = "registertag__main-content">
                        ...
                        <div className = "registertag__main-search"> 
                            ...
                            <input className = "registertag__main-search-input" placeholder = "search for more tags"></input>
                        </div>
